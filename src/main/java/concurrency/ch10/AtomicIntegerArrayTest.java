...
public class AtomicIntegerArrayTest {
    ...
    /**
     * 常见方法列表
     * @see AtomicIntegerArray#addAndGet(int, int) 执行方法，第一个参数为数组的下标，第二个参数为增加的数量，返回增加后的结果
     * @see AtomicIntegerArray#compareAndSet(int, int, int) 对比修改，参数1：数组下标，参数2：原始值，参数3：修改目标值，修改成功返回true否则返回false
     ...
     * @see AtomicIntegerArray#getAndSet(int, int) 将对应下标的数字设置为指定值，第二个参数为设置的值，返回的是变化前的数据
     */
